                ...
                <center>
                    ...
                    <div class="article_content foot_content" >
                        ...
                        <div style="margin-top:10px;text-align: right;">Made by 
                            <a href="{{ url('/user', $row->userpostid) }}"><img src="{{ asset('assets/images/user_pic/'.$row->avatar) }}" onError="this.onerror=null;this.src='{{ asset('assets/images/user_pic/minicons2-14-512.png') }}';"  style="width: 46px;height:auto;vertical-align: -19px;" /> </a></div>
                    </div>
                </center>
            </div>
            @endforeach
             ...
             <div style="cursor: pointer;" class="article" onclick="location.href='{{ url('/recipe', $row->id) }}';">
                ...
                <center>
                    ...
                    <div class="article_content foot_content" >
                        ...
                        <div style="margin-top:10px;text-align: right;">Made by 
                            <a href="{{ url('/user', $row->userpostid) }}"><img onError="this.onerror=null;this.src='{{ asset('assets/images/user_pic/minicons2-14-512.png') }}';" src="{{ asset('assets/images/user_pic/'.$row->avatar) }}"  style="width: 46px;height:auto;vertical-align: -19px;" /> </a></div>
                    </div>
                </center>
            </div>
            @endforeach
